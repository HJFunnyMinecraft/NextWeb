...
function P(props: { content: string; size?: number }) {
  return (
    <Text p size={props.size || 20} css={{ m: 2 }}>
      {props.content}
    </Text>
  );
}
          ...
          <Col className={styles.wrapper}>
            <Card>
              ...
              <Card.Body>
                ...
                <Spacer y={0.5} />
                <a
                  href="https://qm.qq.com/cgi-bin/qm/qr?k=-l6F_4v1HU1Xyk01Gu_kD7d2mc2eKO1L&jump_from=webapi&authKey=wgXsOUYz0lvwCzcHc7FWBSgCbGx4rIeW8Gd4EcxcrPOiI6isHRm3kGVvuZWzpwOE"
                ...
                <Text h6 size={20} css={{ m: 3 }}>
                  mc.hjfunny.site
                </Text>
              </Card.Body>
              <Card.Divider />
              <Card.Body>
                <Text h6 size={24} css={{ m: 3 }}>
                  hjMC生电分服白名单申请
                </Text>
